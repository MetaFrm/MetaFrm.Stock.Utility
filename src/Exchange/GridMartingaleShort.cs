    ...
    public class GridMartingaleShort : Setting, ISettingAction
    {
        ...
        public new void Run(Models.Order? allOrder)
        {
            ...
            if (this.Current == null)
            {
                ...
                {
                    this.SetMartingaleShort(this.User.ExchangeID, this.Market, this.CurrentInfo.TradePrice, this.LossStack.Peek().CurrentInvest);
        ...
        private void GridRun(Grid grid, bool isPush)
        {
            ...
            if (qty > 0 && grid.Market != null)
            {
                ...
                grid.Organized(grid.SettingID, true, true, false, false, false, false, false);
                ...
                this.SetMartingaleShort(this.User.ExchangeID, this.Market ?? "", this.CurrentInfo.TradePrice, qty);
        ...
        private void MartingaleShortRun(Models.Order? allOrder, MartingaleShort MartingaleShort)
        {
            ...
            else
            {
                ...
                if (this.LossStack.Peek().RemainLoss(this.Invest, this.CurrentInfo, MartingaleShort.WorkDataList, MartingaleShort.Fees) > 0)
                {
                    ...
                    MartingaleShort.Organized(MartingaleShort.SettingID, true, true, false, false, false, false, false);
        ...
        private void MartingaleShortRun(MartingaleShort MartingaleShort, bool isPush)
        {
            ...
            if (isPush)
            {
                ...
                this.SetGrid(this.User.ExchangeID, this.Market ?? "", this.CurrentInfo.TradePrice, askAmount);
        ...
        private void SetMartingaleShort(int exchangeID, string market, decimal tradePrice, decimal invest)
        {
            ...
            this.MartingaleShort.TopPrice = GetTopPrice(exchangeID, market, tradePrice, this.MartingaleShort.Rate, this.MartingaleShort.ListMin);
